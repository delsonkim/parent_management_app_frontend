...
const seedClasses: Class[] = [
  ...
  },
  {
    ...
    endsAt: plusHours(daysFromNow(0, 10), 1.5),
    status: "scheduled",
  },
  {
    id: "cls_today_chinese",
    childId: child.id,
    centreId: "ctr_lh",
    tutorId: "t_lh_lee",
    subject: "chinese",
    ...
    endsAt: plusHours(daysFromNow(0, 14), 1.5),
    status: "scheduled",
  },
  {
    id: "cls_today_english",
    childId: child.id,
    centreId: "ctr_bm",
    tutorId: "t_bm_chen",
    subject: "english",
    classCode: "P5-ENG-2",
    level: "Primary 5",
    startsAt: daysFromNow(0, 17, 30),
    endsAt: plusHours(daysFromNow(0, 17, 30), 1.5),
    status: "scheduled",
  },
  {
    id: "cls_003",
